...
public class JdbcDemo {
    ...
    public static final String ADD_NEW_USERS_SQL = """
            ...
            VALUES (DEFAULT, 'Carl1', 'admin', 'ADMIN'),
            (DEFAULT, 'Alisa1', 'qwerty', 'USER'),
            (DEFAULT, 'Bob1', '123', 'GUEST');
            """;
    public static final String DELETE_USERS_MODE_ID3 = "DELETE FROM users WHERE id>38;";
...
//            statement.executeUpdate(DELETE_USERS_MODE_ID3);
