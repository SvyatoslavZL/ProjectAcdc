...
//        URL resource = Winter.class.getResource("NanoSpring.class");
...
//        return s.indexOf(Winter.CLASSES) + Winter.CLASSES.length();
//    }
//
...
//        var typeContractGeneric = Winter.getContractGeneric(type);
