...
public class Configurator {
    ...
    public static final String SECOND_QUEST_NAME = "Сказочная сказка о приключениях богатыря-разработчика!";
    ...
    private void addDemoQuests(UserTo author) {
        ...
        questService.create(
                ...
                """
                        ...
                        8: Ты заходишь в пещеру, а там Кощей, с Бабой Ягой, и Змеем Горынычем смотрят ролики на Youtube. <br>Что будешь делать?
                        12< Ясно что! В Бой!!!
