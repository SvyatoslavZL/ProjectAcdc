...
<body>
<div class="container">
    <jsp:useBean id="user" scope="session" type="com.javarush.kovalinsky.entity.User"/>
        ...
        <div class="col-lg-6 mx-auto">
            <form class="form-horizontal" action="profile" method="post" enctype="multipart/form-data">
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    ...
                    <button type="submit" name="user" class="btn btn-primary btn-lg px-4 gap-3">
                        Редактировать
                    </button>
                    <button type="submit" name="logout" class="btn btn-outline-secondary btn-lg px-4">
                        Выход
                    </button>
                </div>
            </form>
