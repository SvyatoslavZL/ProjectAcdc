    ...
    <div class="container">
        <form action="create-quest" method="post">
            ...
            <div class="mb-3">
                ...
                <input name="name" type="text" class="form-control" id="quest-name" placeholder="Назовите квест">
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('jruDemo').addEventListener('click', function(event) {
                ...
                document.getElementById('quest-name').value = 'Проверка знаний арифметики';
