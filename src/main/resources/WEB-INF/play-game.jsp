...
<div class="container">
    ...
    <jsp:useBean id="user" scope="session" type="com.javarush.kovalinsky.dto.UserTo"/>
    <jsp:useBean id="question" scope="request" type="com.javarush.kovalinsky.dto.QuestionTo"/>
    <jsp:useBean id="game" scope="request" type="com.javarush.kovalinsky.dto.GameTo"/>
                    ...
                    <div class="col-md-4">
                        <c:choose>
                            <c:when test="${not empty question.answers}">
                                <button id="submit" class="btn btn-success">Ответить</button>
                            </c:when>
                            <c:otherwise>
